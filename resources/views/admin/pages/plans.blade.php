        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card subscribe-card">
                ...
                <div class="card-body">
                    ...
                    <div class="my-4">
                        <img src="../assets/images/backgrounds/silver.png" alt="modernize-img" class="img-fluid" width="80"
                            height="80" />
                    </div>
                    ...
                    <button
                        class="btn btn-primary fw-bolder py-6 w-100 text-capitalize subscribe-btn">@lang('Save Changes')</button>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-4">
