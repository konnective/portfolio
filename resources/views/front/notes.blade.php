            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="profile.html">Profile <img src="{{asset('cyborg/assets/images/profile-header.jpg')}}" alt=""></a></li>
                    </ul>   
        ...
        <div class="page-content">
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      <img src="{{asset('cyborg/assets/images/popular-02.jpg')}}" alt="">
                  ...
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      <img src="{{asset('cyborg/assets/images/popular-03.jpg')}}" alt="">
                  ...
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      <img src="{{asset('cyborg/assets/images/popular-04.jpg')}}" alt="">
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-sm-6">
                          <div class="item inner-item">
                            <img src="{{asset('cyborg/assets/images/popular-05.jpg')}}" alt="">
                        ...
                        <div class="col-lg-6 col-sm-6">
                          <div class="item">
                            <img src="{{asset('cyborg/assets/images/popular-06.jpg')}}" alt="">
                  ...
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      <img src="{{asset('cyborg/assets/images/popular-07.jpg')}}" alt="">
                  ...
                  <div class="col-lg-3 col-sm-6">
                    <div class="item">
                      <img src="{{asset('cyborg/assets/images/popular-08.jpg')}}" alt="">
          ...
          <div class="gaming-library">
            <div class="col-lg-12">
              ...
              <div class="item">
                <ul>
                  <li><img src="{{asset('cyborg/assets/images/game-01.jpg')}}" alt="" class="templatemo-item"></li>
              ...
              <div class="item">
                <ul>
                  <li><img src="{{asset('cyborg/assets/images/game-02.jpg')}}" alt="" class="templatemo-item"></li>
              ...
              <div class="item last-item">
                <ul>
                  <li><img src="{{asset('cyborg/assets/images/game-03.jpg')}}" alt="" class="templatemo-item"></li>
